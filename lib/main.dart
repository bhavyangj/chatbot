...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future response(query) async {
    ...
    print("message received from AI: " + Response.getListMessage()[0]["text"]["text"][0].toString());
    setState(() {
      messsages.insert(0, {
        "data": 0,
    ...
    print("messgae recied from AI: " + Response.getListMessage()[0]["text"]["text"][0].toString());
  }
